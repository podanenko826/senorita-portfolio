...
export default function Header() {
  return (
    <div>
      <div className=" flex bg-slate-000 py-4  border-stone-400 py_-9">
        ...
        <div className="flex-1 flex-auto  px-6 uppercase text-center leading-normal tracking-wider lg:text-5xl lg:leading-snug mb-6">
